...
<body>
	...
	<section class="login_box_area section_gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img my-5">
						<img class="img-fluid" src="<?=base_url()?>static/karma/img/paises/x.jpg" alt="">
						<div class="hover">
							<h4>Conoce nuestra página web</h4>
							<p>¡Bienvenido a Karma Tu puerta de acceso a un mundo de destinos. Inicia sesión para despegar hacia nuevas experiencias.</p>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						<div class="d-flex align-items-center vh-100">
							<div class="alert alert-success w-50 mx-auto d-none" role="alert" id="operation">
						...
						<form class="row login_form" action="contact_process.php" method="post" id="contactForm"
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="name" placeholder="Nombre completo"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nombre completo'" required>
							</div>
							<div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="direccion" placeholder="Dirección"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Dirección'" required>
							</div>
							<div class="col-md-12 form-group">
								<input type="number" class="form-control" id="phone" placeholder="Teléfono"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Teléfono'" required>
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="contra" placeholder="Contraseña"
									onfocus="this.placeholder = ''" onblur="this.placeholder = 'Contraseña'" required>
							</div>
							<div class="col-md-12 form-group d-none">
								<p class="text-danger text-left d-none" id="pasIncorrect">La contraseña no coincide</p>
								<input type="password" class="form-control" id="contra2"
									placeholder="Contraseña nuevamente" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Contraseña'" required>
							</div>
							<div class="col-md-12 form-group">
								<button type="button" class="primary-btn" id="btn-createAccount">Crear cuenta</button>
							</div>
						</form>
					</div>
				</div>
	...
	<script src="<?=base_url()?>static/scrips/scripts/login.js"></script>
