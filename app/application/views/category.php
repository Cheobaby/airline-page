			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						...
						<a href="<?=site_url()?>/frontend/category">Fashon Category</a>
					</nav>
				</div>
			</div>
		</div>
			...
			<div class="col-xl-3 col-lg-4 col-md-5">
				<div class="sidebar-categories">
					...
					<ul class="main-categories">
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#InicioClean" aria-expanded="false" aria-controls="InicioClean"><span
								 class="lnr lnr-arrow-right"></span>Inicio and Cleaning<span class="number">(53)</span></a>
							<ul class="collapse" id="InicioClean" data-toggle="collapse" aria-expanded="false" aria-controls="InicioClean">
								<li class="main-nav-list child"><a href="#">Frozen Fish<span class="number">(13)</span></a></li>
								<li class="main-nav-list child"><a href="#">Dried Fish<span class="number">(09)</span></a></li>
								<li class="main-nav-list child"><a href="#">Fresh Fish<span class="number">(17)</span></a></li>
								<li class="main-nav-list child"><a href="#">Meat Alternatives<span class="number">(01)</span></a></li>
						...
						<li class="main-nav-list"><a data-toggle="collapse" href="#InicioAppliance" aria-expanded="false" aria-controls="InicioAppliance"><span
								 class="lnr lnr-arrow-right"></span>Inicio Appliances<span class="number">(15)</span></a>
							<ul class="collapse" id="InicioAppliance" data-toggle="collapse" aria-expanded="false" aria-controls="InicioAppliance">
								<li class="main-nav-list child"><a href="#">Frozen Fish<span class="number">(13)</span></a></li>
								<li class="main-nav-list child"><a href="#">Dried Fish<span class="number">(09)</span></a></li>
								<li class="main-nav-list child"><a href="#">Fresh Fish<span class="number">(17)</span></a></li>
								<li class="main-nav-list child"><a href="#">Meat Alternatives<span class="number">(01)</span></a></li>
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?=base_url()?>static/karma/img/product/p1.jpg" alt="">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?=base_url()?>static/karma/img/product/p2.jpg" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?=base_url()?>static/karma/img/product/p3.jpg" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?=base_url()?>static/karma/img/product/p4.jpg" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?=base_url()?>static/karma/img/product/p5.jpg" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="<?=base_url()?>static/karma/img/product/p6.jpg" alt="">
								<div class="product-details">
									<h6>addidas New Hammer sole
										for Sports person</h6>
									<div class="price">
					...
					<div class="row">
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r1.jpg" alt=""></a>
								<div class="desc">
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r2.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r3.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r5.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r6.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6 mb-20">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r7.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r9.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r10.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
						...
						<div class="col-lg-4 col-md-4 col-sm-6">
							<div class="single-related-product d-flex">
								<a href="#"><img src="<?=base_url()?>static/karma/img/r11.jpg" alt=""></a>
								<div class="desc">
									<a href="#" class="title">Black lace Heels</a>
									<div class="price">
										<h6>$189.00</h6>
				...
				<div class="col-lg-3">
					<div class="ctg-right">
						<a href="#" target="_blank">
							<img class="img-fluid d-block mx-auto" src="<?=base_url()?>static/karma/img/category/c5.jpg" alt="">
						</a>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-3  col-md-6 col-sm-6">
					<div class="single-footer-widget mail-chimp">
						...
						<ul class="instafeed d-flex flex-wrap">
							<li><img src="<?=base_url()?>static/karma/img/i1.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i2.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i3.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i4.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i5.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i6.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i7.jpg" alt=""></li>
							<li><img src="<?=base_url()?>static/karma/img/i8.jpg" alt=""></li>
						</ul>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="quick-view-carousel">
								<div class="item" style="background: url(<?=base_url()?>static/karma/img/organic-food/q1.jpg);">
	...
	<script src="<?=base_url()?>static/karma/js/vendor/jquery-2.2.4.min.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4"
	 crossorigin="anonymous"></script>
	<script src="<?=base_url()?>static/karma/js/vendor/bootstrap.min.js"></script>
	<script src="<?=base_url()?>static/karma/js/jquery.ajaxchimp.min.js"></script>
	<script src="<?=base_url()?>static/karma/js/jquery.nice-select.min.js"></script>
	<script src="<?=base_url()?>static/karma/js/jquery.sticky.js"></script>
	<script src="<?=base_url()?>static/karma/js/nouislider.min.js"></script>
	<script src="<?=base_url()?>static/karma/js/jquery.magnific-popup.min.js"></script>
	<script src="<?=base_url()?>static/karma/js/owl.carousel.min.js"></script>
	<!--gmaps Js-->
	<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
	<script src="<?=base_url()?>static/karma/js/gmaps.min.js"></script>
	<script src="<?=base_url()?>static/karma/js/main.js"></script>
</body>
